        ...
        <div className='mt-5'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-5'>
                {businessList.length > 0 ? businessList.map((business, index) => (
                    <Link href={'/details/'+business.id} key={index} className='shadow-md rounded-lg hover:shadow-lg hover:shadow-primary cursor-pointer hover:scale-100 transition-all ease-in-out'>
                    ...
                    [1, 2, 3, 4, 5, 6, 7, 8].map((item, index) => (
                        <div key={index} className='w-full h-[340px] bg-slate-200 rounded-lg animate-pulse'>
